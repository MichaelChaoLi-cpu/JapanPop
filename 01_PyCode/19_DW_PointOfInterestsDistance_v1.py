...
if firstTimeRunCode:
    ...
    gdf = gpd.read_file(aimFolder + "\\MergedPark.shp")
...
if firstTimeRunCode:
    ...
    gdf = gpd.read_file(aimFolder + "\\MergedWelfare.shp")
...
if firstTimeRunCode:
    ...
    gdf = gpd.read_file(aimFolder + "\\MergedFirestation.shp")
